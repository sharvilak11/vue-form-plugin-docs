<template>
    <aside class="sidebar" :class="{'sidebar--open' : this.$store.state.sidebarOpen}">
      <nav>
        ...
        <GitLink git="GitHub" link="https://github.com/sharvilak11/vue-form-plugin" class="git" />
        <GitLink git="GitLab" link="http://git.e9ine.com/sharvilak/vue-form-plugin" text="Check me out on GitLab" class="git git-lab" />
      </nav>
    </aside>
</template>
